...
const products = [
  ...
  { sku: 'KHF-003', slug: 'brazil-cerrado', name: 'Brazil Cerrado', description: 'Düşük asidite ve yoğun gövde. Sütlü içecekler için ideal bir tercih.', price: 230, salePrice: null, discountRate: 0, vatRate: 20, categoryName: 'Çekirdek', stock: 200, warehouse: 'Merkez Depo', isActive: true, images: JSON.stringify(['https://images.unsplash.com/photo-1559056199-6b57974e5b96?q=80&w=800&auto=format&fit=crop']) },
  { sku: 'EKP-003', slug: 'fellow-stagg-kettle', name: 'Fellow Stagg Kettle', description: 'Hassas akış kontrolü ve mat siyah tasarımıyla profesyonel bir demleme deneyimi.', price: 1250, salePrice: 999, discountRate: 20, vatRate: 20, categoryName: 'Ekipman', stock: 20, warehouse: 'Merkez Depo', isActive: true, images: JSON.stringify(['https://images.unsplash.com/photo-1517668808822-9ebb02f2a0e6?q=80&w=800&auto=format&fit=crop']) },
  { sku: 'KHF-004', slug: 'kenya-aa', name: 'Kenya AA', description: 'Keskin asidite ve meyvemsi tatlar. Kenyasnın en iyi kahve sınıfı.', price: 310, salePrice: null, discountRate: 0, vatRate: 20, categoryName: 'Çekirdek', stock: 80, warehouse: 'Merkez Depo', isActive: true, images: JSON.stringify(['https://images.unsplash.com/photo-1524350300060-d39f447a20ab?q=80&w=800&auto=format&fit=crop']) },
  { sku: 'AKS-001', slug: 'hario-dripper', name: 'Hario V60 Dripper', description: 'Klasik seramik damlatıcı. Şeffaf ve temiz bir kahve içimi için.', price: 185, salePrice: null, discountRate: 0, vatRate: 20, categoryName: 'Aksesuar', stock: 120, warehouse: 'Merkez Depo', isActive: true, images: JSON.stringify(['https://images.unsplash.com/photo-1511920170033-f8396924c348?q=80&w=800&auto=format&fit=crop']) },
  { sku: 'EKP-004', slug: 'timemore-grinder', name: 'Timemore C2 Değirmen', description: 'Taşınabilir ve ayarlanabilir el değirmeni. Paslanmaz çelik bıçaklar.', price: 750, salePrice: 620, discountRate: 17, vatRate: 20, categoryName: 'Ekipman', stock: 40, warehouse: 'Merkez Depo', isActive: true, images: JSON.stringify(['https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?q=80&w=800&auto=format&fit=crop']) },
  { sku: 'KHF-005', slug: 'guatemala-antigua', name: 'Guatemala Antigua', description: 'Volkanik toprakların zenginliği. Baharatlı ve çikolatalı notalar.', price: 295, salePrice: null, discountRate: 0, vatRate: 20, categoryName: 'Çekirdek', stock: 90, warehouse: 'Merkez Depo', isActive: true, images: JSON.stringify(['https://images.unsplash.com/photo-1559056199-c0205562767c?q=80&w=800&auto=format&fit=crop']) },
  { sku: 'AKS-002', slug: 'goat-story-mug', name: 'Goat Story Kupa', description: 'Keçi boynuzu tasarımıyla ikonik bir taşıma kupası.', price: 420, salePrice: null, discountRate: 0, vatRate: 20, categoryName: 'Aksesuar', stock: 60, warehouse: 'Merkez Depo', isActive: true, images: JSON.stringify(['https://images.unsplash.com/photo-1517142089942-0f0f3-a78a63f2?q=80&w=800&auto=format&fit=crop']) },
